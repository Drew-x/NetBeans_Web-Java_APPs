...
public class CollectionDemo {
    ...
    public static double addAndDeleteDoubles( Collection c ) {
      ...
      Iterator iterator = c.iterator() ;    	// get iterator for collection c

      while ( iterator.hasNext() ){ 		// more items in the collection...       				
        
         Object temp = iterator.next() ;	// ... get next Object
        
         if ( temp instanceof Double ){ 	// ... if it's a Double...
         			
            sum += (Double) temp ;	// ...downcast and add to sum
            iterator.remove() ;            	// ...and delete it 
         }
      } 
