 ...
 */
package collectionsmethodsdemo;
...
public class CollectionsMethodsDemo
{
    ...
    public static void main(String args[])
    {
        String collections1[] =
        {
            "stamps", "baseball cards", "coins"
        };
        String collections2[] =
        {
            "Barbie dolls", "autographs"
        };

        ArrayList<String> collectables =
                new ArrayList<String>(Arrays.asList(collections1));
        ...
        System.out.println("smallest value in the list is: "
                + Collections.min(collectables) + '\n');

        System.out.println("largest value in the list is: "
                + Collections.max(collectables) + '\n');
...
printing list after concatenation...
stamps  baseball cards  coins  Barbie dolls  butterflies

printing list after reverse...
butterflies  Barbie dolls  coins  baseball cards  stamps

printing list after shuffle...
coins  baseball cards  Barbie dolls  stamps  butterflies
...
Barbie dolls  baseball cards  butterflies  coins  stamps

search for "coupons" returns -5

printing list after inserting "coupons"...
Barbie dolls  baseball cards  butterflies  coins  coupons  stamps
