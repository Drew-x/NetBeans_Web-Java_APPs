...
/**
 * A class to represent rational numbers.  I.e., any number that can be 
 * expressed as the quotient of 2 integers (i.e., a "fraction", such as 3/7).
 * Rational objects are always reduced to lowest terms.
 */
class Rational implements Comparable
{
	...
	/**
	 * One-argument constructor creates Rational object with numerator specified
	 * by user and denominator of 1.
	 ...
	 * Postconditions:  
	 *   1. the Rational object created is reduced to lowest terms
	 *   2. the denominator will be positive
	 *   3. if the user specifies a zero denominator, 0/1 is created instead
	 */
	...
	/**
	 * Overridden compareTo method orders Rational objects by their decimal 
	 * values.
	 * @param otherObject explicit parameter to which the implicit parameter
	 * is being compared.
